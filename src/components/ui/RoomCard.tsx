...
export function RoomCard({ room }: { room: RoomCategory }) {
  ...
  return (
    <article className="group flex h-full flex-col overflow-hidden rounded-3xl border border-diamanti-sand/80 bg-white shadow-soft transition duration-300 hover:-translate-y-1">
      <SmartImage
      ...
      <div className="flex flex-1 flex-col p-6">
        <p className="text-xs uppercase tracking-[0.16em] text-diamanti-sea">
        ...
        <dl className="mt-5 grid gap-3 rounded-2xl bg-diamanti-sand/15 p-4 text-sm">
          <div>
        ...
        >
          <div className="overflow-hidden">
            <div className="space-y-4 rounded-2xl border border-diamanti-sand/60 bg-diamanti-ivory/70 p-4 text-sm md:text-base">
